...
**Verification**: contracts registry `registry/organization/repositories/llm_code_navigator.yaml` の spec.parent と一致することを確認（contracts commit ecbc226、validate/lint 0 errors 済み）。
